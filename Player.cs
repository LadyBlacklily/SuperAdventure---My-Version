...
namespace Engine
{
    public class Player : LivingCreature            // die Ober-Klasse Player, die nur als Blaupause für den Spieler Player verwendet wird
    {
        public int Gold { get; set; }               // Der Wert kann abgerufen (get) und festgelegt (set) werden
        public int ExperiencePoints { get; set; }
        public Location CurrentLocation { get; set; }
        public List<InventoryItem> Inventory { get; set; }
        public List<PlayerQuest> Quests { get; set; }

        public int Level                            //Level steigt automatisch mit den Erfahrungspunkten
        {
